...
<title>Billing History | UCC Music Hub</title>
<meta name="description" content="User Billing History">
<meta property="og:title" content="Billing History | UCC Music Hub">
<meta property="og:description" content="User Billing History">
...
<li class="nav-item ms-lg-2"><a class="btn btn-ucc btn-sm" href="/register">Join Free</a></li>
  ...
  <nav>
  <a href="dashboard.blade.php" class=""><i class="bi bi-speedometer2"></i> Dashboard</a><a href="profile.blade.php" class=""><i class="bi bi-person"></i> Profile</a><a href="my-/playlists" class=""><i class="bi bi-music-note-list"></i> My Playlists</a><a href="favorite-/songs" class=""><i class="bi bi-heart"></i> Favorite Songs</a><a href="liked-/albums" class=""><i class="bi bi-disc"></i> Liked Albums</a><a href="comments.blade.php" class=""><i class="bi bi-chat"></i> Comments</a><a href="billing-history.blade.php" class="active"><i class="bi bi-credit-card"></i> Billing</a><a href="notifications.blade.php" class=""><i class="bi bi-bell"></i> Notifications</a><a href="settings.blade.php" class=""><i class="bi bi-gear"></i> Settings</a>
  </nav>
</aside><div class="col-lg-9 p-4 p-md-5"><h2 class="serif mb-4">Billing History</h2><div class="card border-0 shadow-sm"><div class="table-responsive"><table class="table align-middle mb-0"><thead class="table-light"><tr><th>Invoice</th><th>Plan</th><th>Date</th><th>Amount</th><th>Status</th><th></th></tr></thead><tbody><tr><td>#UCC-2026-001</td><td>Premium Annual</td><td>Jun 6, 2026</td><td>$89.00</td><td><span class="badge bg-success">Paid</span></td><td><button class="btn btn-sm btn-light"><i class="bi bi-download"></i></button></td></tr><tr><td>#UCC-2026-002</td><td>Premium Annual</td><td>Jun 7, 2026</td><td>$89.00</td><td><span class="badge bg-success">Paid</span></td><td><button class="btn btn-sm btn-light"><i class="bi bi-download"></i></button></td></tr><tr><td>#UCC-2026-003</td><td>Premium Annual</td><td>Jun 8, 2026</td><td>$89.00</td><td><span class="badge bg-success">Paid</span></td><td><button class="btn btn-sm btn-light"><i class="bi bi-download"></i></button></td></tr><tr><td>#UCC-2026-004</td><td>Premium Annual</td><td>Jun 9, 2026</td><td>$89.00</td><td><span class="badge bg-success">Paid</span></td><td><button class="btn btn-sm btn-light"><i class="bi bi-download"></i></button></td></tr><tr><td>#UCC-2026-005</td><td>Premium Annual</td><td>Jun 10, 2026</td><td>$89.00</td><td><span class="badge bg-success">Paid</span></td><td><button class="btn btn-sm btn-light"><i class="bi bi-download"></i></button></td></tr></tbody></table></div></div></div></div></div></main>
