...
<title>Verify Email | UCC Music Hub</title>
<meta name="description" content="Verify Email page">
<meta property="og:title" content="Verify Email | UCC Music Hub">
<meta property="og:description" content="Verify Email page">
...
<div class="text-center">
  <i class="bi bi-envelope-check display-1 text-ucc-primary"></i>
  <h3 class="serif mt-3">Verify Your Email</h3>
  <p class="text-muted">We sent a verification link to <strong>you@email.com</strong>. Click the link to activate your account.</p>
  <button class="btn btn-ucc btn-lg">Resend Email</button>
  <p class="mt-3 small"><a href="/login" class="text-ucc-primary">Back to sign in</a></p>
