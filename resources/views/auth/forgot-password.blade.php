...
<title>Forgot Password | UCC Music Hub</title>
<meta name="description" content="Forgot Password page">
<meta property="og:title" content="Forgot Password | UCC Music Hub">
...
<h3 class="serif mb-1">Reset Password</h3>
<p class="text-muted mb-4">Enter your email and we'll send you a reset link.</p>
<form>
  <div class="mb-3"><label class="form-label">Email Address</label><input type="email" class="form-control form-control-lg"></div>
  <button class="btn btn-ucc btn-lg w-100">Send Reset Link</button>
  <p class="text-center mt-3 mb-0 small"><a href="/login" class="text-ucc-primary">Back to sign in</a></p>
