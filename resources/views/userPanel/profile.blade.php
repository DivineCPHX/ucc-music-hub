...
<title>Profile | UCC Music Hub</title>
<meta name="description" content="User Profile">
<meta property="og:title" content="Profile | UCC Music Hub">
...
<li class="nav-item ms-lg-2"><a class="nav-link d-flex align-items-center active" href="profile.blade.php" title="My Profile"><img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80" alt="Profile" style="width:32px;height:32px;border-radius:50%;object-fit:cover;border:2px solid var(--ucc-gold)"></a></li>
...
<li class="nav-item ms-lg-2"><a class="btn btn-ucc btn-sm" href="/register">Join Free</a></li>
  ...
  <nav>
  <a href="dashboard.blade.php" class=""><i class="bi bi-speedometer2"></i> Dashboard</a><a href="profile.blade.php" class="active"><i class="bi bi-person"></i> Profile</a><a href="my-/playlists" class=""><i class="bi bi-music-note-list"></i> My Playlists</a><a href="favorite-/songs" class=""><i class="bi bi-heart"></i> Favorite Songs</a><a href="liked-/albums" class=""><i class="bi bi-disc"></i> Liked Albums</a><a href="comments.blade.php" class=""><i class="bi bi-chat"></i> Comments</a><a href="billing-history.blade.php" class=""><i class="bi bi-credit-card"></i> Billing</a><a href="notifications.blade.php" class=""><i class="bi bi-bell"></i> Notifications</a><a href="settings.blade.php" class=""><i class="bi bi-gear"></i> Settings</a>
  </nav>
</aside><div class="col-lg-9 p-4 p-md-5">
<h2 class="serif mb-4">My Profile</h2>
<div class="card border-0 shadow-sm p-4">
  <div class="d-flex align-items-center gap-4 mb-4">
    <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300" class="rounded-circle" style="width:120px;height:120px;object-fit:cover" alt="">
    <div><h4 class="serif mb-1">Sarah Mitchell</h4><p class="text-muted mb-2">sarah@email.com</p><button class="btn btn-outline-ucc btn-sm" style="color:var(--ucc-primary);border-color:var(--ucc-primary)">Change Photo</button></div>
  </div>
  <form class="row g-3">
    <div class="col-md-6"><label class="form-label">Full Name</label><input class="form-control" value="Sarah Mitchell"></div>
    <div class="col-md-6"><label class="form-label">Email</label><input class="form-control" value="sarah@email.com"></div>
    <div class="col-md-6"><label class="form-label">Phone</label><input class="form-control" value="+1 555 010 9988"></div>
    <div class="col-md-6"><label class="form-label">Location</label><input class="form-control" value="Nashville, TN"></div>
    <div class="col-12"><label class="form-label">Bio</label><textarea class="form-control" rows="3">Worship leader, mom, coffee lover.</textarea></div>
    <div class="col-12"><button class="btn btn-ucc">Save Changes</button></div>
  </form>
